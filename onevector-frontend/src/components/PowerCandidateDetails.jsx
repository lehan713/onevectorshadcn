...
<div className="min-h-screen bg-white text-black font-sans dark:bg-gray-900 dark:text-gray-100">
  ...
  <div className="bg-white rounded-lg p-6 mb-0 mt-14 relative px-0 dark:bg-gray-800">
    ...
    <div className="border-b-0 py-4 flex items-center justify-between flex-wrap space-y-4 sm:space-y-0">
      ...
      {/* Action Buttons */}
<div className="flex space-x-4 mr-5 flex-wrap justify-center mt-4 sm:mt-0 ml-5 w-full md:w-auto space-y-4 md:space-y-0">
  {/* View Resume Button */}
  <button
    onClick={handleDownloadResume}
    className="px-4 py-2 text-white font-medium rounded-lg bg-gradient-to-r from-[#15abcd] to-[#094DA2] hover:opacity-90 transform hover:scale-105 hover:underline transition-all duration-200 flex items-center"
  >
